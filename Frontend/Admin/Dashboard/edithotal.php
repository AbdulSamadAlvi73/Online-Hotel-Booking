...
include("./conn.php");
  $id=$_GET['id'];
  $sel="SELECT * FROM `hotels` WHERE id='$id'";
 ...
 if(isset($_POST['submit'])){
  ...
  $query = "UPDATE `hotels` SET `name`='$name', `description`='$description', `cityId`='$city_id', `price`='$price', `image`='$target' WHERE `id`='$id'";
  $query_run = mysqli_query($conn, $query);

  if($query_run) {
      header('location:viewhotals.php');
  } else {
 ...
 <!-- End Sidebar-->
  ...
  <main id="main" class="main">
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Edit Hotal</h5>
            ...
            <form class="row g-3" action="#" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="city" name="city" value="<?php echo $row['cityId']?>">
              </div>
              <div class="col-12">
