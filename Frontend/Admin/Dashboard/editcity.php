...
include("./conn.php");
  $id=$_GET['id'];
  $sel="SELECT * FROM `cities` WHERE id='$id'";
  $res=mysqli_query($conn,$sel);
  $row=mysqli_fetch_array($res);
 if(isset($_POST['submit'])){
  $city = $_POST['city'];

  $query = "UPDATE `cities` SET `city_name`='$city' WHERE `id`='$id'";
          ...
          <div class="card-body">
            ...
            <form class="row g-3" action="#" method="POST">
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="city" name="city" value="<?php echo $row['city_name']?>">
              </div>
              <!-- <div class="col-12">
