...
if(isset($_POST['submit'])){
  ...
  $query = "INSERT INTO `birthday` (`hotal_name`, `description`, `city`, `price`, `image`) VALUES ('$hotal_name','$description','$city','$price','$target')";
 ...
 <!-- End Sidebar-->
  ...
  <main id="main" class="main">
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Add Birthday</h5>

            <!-- Vertical Form -->
            <form class="row g-3" action="#" method="POST" enctype="multipart/form-data">
              <div class="col-12">
                <label for="hotal_name" class="form-label">Hotel Name</label>
                <input type="text" class="form-control" id="hotal_name" name="hotal_name">
              </div>
              <div class="col-12">
