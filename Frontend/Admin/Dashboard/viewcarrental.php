    ...
    <table class="table table-hover">
      <thead class="samad-dashborad-header">
        <tr>
          ...
          <th scope="col">Big Suitcases</th>
          <th scope="col">Small Suitcases</th>
      ...
      <?php
       ...
       <tr>
          ...
          <td><?php echo $row['big_suitcases'] ?></td>
          <td><?php echo $row['small_suitcases'] ?></td>
          <td><?php echo $row['price'] ?></td>
          <td><img src="<?php echo $row['image'] ?>" alt="Image" height="70" width="140"></td>
          <td class="text-center"><a href="./editcarrental.php?id=<?php echo $row['id']?>"><i class="bi bi-pencil-square text-primary"></i></a></td>
