...
include("./conn.php");
  $id=$_GET['id'];
  $sel="SELECT * FROM `wedding` WHERE id='$id'";
 ...
 if(isset($_POST['submit'])){
  ...
  move_uploaded_file($image_temp, $target);
    ...
    $query = "UPDATE `wedding` SET `hotal_name`='$hotal_name', `description`='$description', `city`='$city', `price`='$price', `image`='$target' WHERE `id`='$id'";
 ...
 <!-- End Sidebar-->
  ...
  <main id="main" class="main">
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Edit Wedding</h5>
